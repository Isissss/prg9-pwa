...
export default function ProjectPage({ project, links }: ProjectT) {
    ...
    return (
        <div className="relative flex justify-center flex-col "> 
            ...
            <div className=" content-['']  absolute  -z-10  inset-0  w-full h-full bg-gradient-to-t from-black/80" />
            ...
            <div className=" absolute slide-in-from-bottom-1/2 animate-in transition-transform duration-200 left-8 bottom-3  max-w-2xl   z-20 ">
                ...
                <div className="absolute bg-[#d3104c] text-white w-fit p-5 rounded-sm top-0 right-0 md:mx-auto text-xl z-20 ">
                    <p className="font-bold">{author}</p>
                </div> 
            </div>
            <div className="max-w-2xl   my-5   md:mx-auto mx-[15px] slide-in-from-bottom-1/2 animate-in transition-all duration-200">

                <div className="flex flex-row justify-between space-x-3 mt-6 text-xl">
                    <p className="font-bold">{author}</p>
                ...
                <div className="mb-6">
                    <h2 className="font-bold text-xl mb-2"> Screenshots ({screenshots.length})</h2>
